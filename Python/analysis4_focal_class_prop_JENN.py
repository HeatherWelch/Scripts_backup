...
for file in arcpy.ListFiles():
	env.workspace="F:\\parent_folder\\rasters\\"+file
	for raster in arcpy.ListRasters():
		bname=arcpy.Describe(raster).basename
		zonal="F:\\parent_folder\\remapped_clusters_final\\"+file+"_edit"
		#zonal="F:\\parent_folder\\remapped_clusters_final\\"+file+"_edit_del2a"
...
#months=["m01","m02","m03","m04","m05","m06","m07","m08","m09","m10","m11","m12"]			
# env.workspace="F:\\wherever\\"
# out_workspace="F:\\wherever\\aggregated\\"
# for month in months:
	# wildcard=month+"*"
